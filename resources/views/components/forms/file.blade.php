<div {{ $attributes->merge(['class' => '']) }}>
    <label for="document-dropzone" class="inline-block mb-2 text-sm">
        {{$label}}
    </label>
    <div class=" border-dashed border-2 w-full h-52 rounded flex justify-center items-center needsclick dropzone" id="document-dropzone">
        ...
        <script>
            ...
            Dropzone.options.documentDropzone = {
                ...
                init: function() {
                        ...
                        var files = {!! json_encode($media) !!}
                        for (var i in files) {
                            var file = files[i]
                            this.options.addedfile.call(this, file)
                            // this.options.thumbnail.call(this, file, 'https://via.placeholder.com/300x300')
